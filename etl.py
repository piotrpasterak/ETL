...
class ETLApp(App):
    ...
    def build(self):
        text_city = TextInput(text='Please enter city', multiline=False, size_hint = (.6,.1), pos_hint ={'x': .1, 'y': .8})
        city_input = Button(text="Enter", size_hint=(.2, .1), pos_hint={'x': .7, 'y': .8})
